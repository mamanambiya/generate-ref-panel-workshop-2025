...
## Federated Genotype Imputation Pipeline - Local Docker Version
...
## Uses locally built Docker container: federated-imputation:latest
...
task ExtractRegion {
    ...
    runtime {
        docker: "federated-imputation:latest"
        memory: "4 GB"
        cpu: 2
...
workflow FederatedImputationPipeline {
    ...
    meta {
        description: "Federated Genotype Imputation Pipeline - Local Docker Version"
        author: "GA4GH Hackathon 2025 - African Genomics Team"
