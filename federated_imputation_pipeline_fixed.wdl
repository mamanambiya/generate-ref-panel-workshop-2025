...
## Federated Genotype Imputation Pipeline - Fixed for Apple Silicon
...
workflow FederatedImputationPipeline {
    ...
    meta {
        description: "Federated Genotype Imputation Pipeline - Fixed for Apple Silicon"
        author: "GA4GH Hackathon 2025 - African Genomics Team"
        email: "team@afrigenomics.org"
        version: "1.0.0"
        docker: "mamana/minimac4-all"
        notes: "Uses --platform linux/amd64 for cross-platform compatibility"
    }
